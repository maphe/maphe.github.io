const i18n = {
  en: {
    heroes: {
      ...
      assassin_cidd: 'a.cidd',
      assassin_coli: 'a.coli',
      auxiliary_lots: 'a.lots',
      azalea: '',
      baal_and_sezan: '',
      baiken: '',
      basar: '',
...
const heroName = (id) => {
  ...
  if (lang === 'en') {
    ...
    return (i18n[lang].heroes[id].split("|"))[0] || heroes[id].name;
  }
};
...
const heroaltName = (id) => {
  const lang = document.getElementById('root').getAttribute('lang');
  if (lang === 'en') {
    return i18n[lang].heroes[id] || '';
  } else {
    return (i18n[lang].heroes[id].split("|"))[1] || '';
  }
};
