const i18n = {
  jp: {
    ...
    form: {
      nb_targets: '敵数',
      nb_hits: 'ヒット数',
      target_max_hp: 'ターゲットの最大生命力',
      target_hp_pc: 'ターゲットの生命力 %',
      target_hp: 'ターゲットの生命力',
      target_speed: 'ターゲットのスピード',
      target_nb_buff: 'ターゲットについてるバフの数',
      target_nb_debuff: 'ターゲットについてるデバフの数',
