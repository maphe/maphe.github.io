const i18n = {
  ...
  pt: {
    heroes: {
      ...
      hwayoung_old: 'Hwa Young Antiga',
      vildred_old: 'Vildred Antigo',
      bad_cat_armin_old: 'Armina Gatinha Malvada Antiga',
      jena_old: 'Jena Antiga',
      // End Pre-Balance
      achates: 'Acates',
      adin: 'Adine',
      adlay: 'Adlay',
    ...
    form: {
      ...
      caster_max_hp: 'Vida Máxima',
      caster_hp_pc: '% Vida',
      caster_hp: 'Vida',
      caster_hp_above_50pc: 'Vida abaixo de 50%',
      caster_defense: 'Defesa',
      caster_defense_up: 'Aumento de Defesa',
      caster_speed: 'Speed',
      caster_speed_up: 'Aumento de Speed',
      caster_nb_buff: 'Quantidade de Buffs',
      caster_turn: 'Próprio Turno',
      caster_has_debuff: 'Tem Debuff',
      caster_has_flame_alchemist: 'Alquimista das Chamas',
      caster_full_focus: 'Foco Completo',
      caster_nb_focus: 'Quantidade de Foco',
      caster_fighting_spirit: 'Espírito de Luta',
      caster_invincible: 'Invencível',
      caster_vigor: 'Vigor',
      caster_enrage: 'Enfurecido',
      caster_stealth: 'Stealth',
      caster_perception: 'Percepção',
      critical_hit_stack: 'Stack de Chance Crítica',
      critical_hit_stack_12: 'Stack de Chance Crítica',
      attack_skill_stack_3: 'Stack de Chance Crítica',
      attack_skill_stack_5: 'Stack de Chance Crítica',
      non_attack_skill_stack_3: 'Stack de Habilidade que não seja de Ataque',
      non_attack_skill_stack_8: 'Stack de Habilidade que não seja de Ataque',
      non_attack_skill_stack_10: 'Stack de Habilidade que não seja de Ataque',
      ...
      skill_tree_completed: 'Skill 3 Completa',
      s3_stack: 'Stack S3',
